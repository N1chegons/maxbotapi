...
from maxapi.types import MessageCreated, BotStarted, MessageButton, InputMedia
from maxapi.utils.inline_keyboard import InlineKeyboardBuilder

from src.admin.repository import AdminService
from src.config import settings
from src.max.models import ThemeChoice, ConsultChoice, WaitingForPhone
...
async def new_theme(event: MessageCreated, context: MemoryContext):
    ...
    await AdminService.log_command_admin(user_id, "/mark")
