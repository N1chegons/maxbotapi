...
async def handle_agree_subs(callback):
    ...
    await callback.message.answer(
        text=(
            "Ты посмотрел видео и выбрал память.\nОцени свой уровень доверия ⚠️ Если информации недостаточно, изучи сайт.\nСначала тест, потом автоматические списания по 650р каждый 31 день.\n\nЕсли что-то не понял и хочешь вернуться назад, напиши /new"
        ),
